...
// Returns the public 'liform' shared service.
...
return $this->services['liform'] = new \Limenius\Liform\Liform(($this->services['liform.resolver'] ?? $this->load('getLiform_ResolverService.php')));
