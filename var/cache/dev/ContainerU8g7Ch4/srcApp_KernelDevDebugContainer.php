...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\MajPanel\\Api\\Autor\\AutorCrudController' => 'getAutorCrudControllerService.php',
            'App\\Controller\\Admin\\MajPanel\\Api\\Blog\\CrudControllerBlog' => 'getCrudControllerBlogService.php',
            'App\\Controller\\Admin\\MajPanel\\Api\\Book\\BookCrudController' => 'getBookCrudControllerService.php',
            'App\\Controller\\Admin\\MajPanel\\Grid\\Autor\\HomeController' => 'getHomeControllerService.php',
            'App\\Controller\\Admin\\MajPanel\\Grid\\Blog\\HomeController' => 'getHomeController2Service.php',
            'App\\Controller\\Admin\\MajPanel\\Grid\\Book\\HomeController' => 'getHomeController3Service.php',
            'App\\Controller\\Admin\\MajPanel\\HomeController' => 'getHomeController4Service.php',
            'App\\Controller\\Blog\\BlogHomeController' => 'getBlogHomeControllerService.php',
            'App\\Controller\\SecurityController' => 'getSecurityControllerService.php',
            'App\\Controller\\Security\\LoginFormAuthenticator' => 'getLoginFormAuthenticatorService.php',
            'App\\Services\\MajPanel\\ApiService' => 'getApiServiceService.php',
            ...
            'liform' => 'getLiformService.php',
            'liform.add_schema_extension' => 'getLiform_AddSchemaExtensionService.php',
            'liform.guesser.validator' => 'getLiform_Guesser_ValidatorService.php',
            'liform.resolver' => 'getLiform_ResolverService.php',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['kernel.listener.manage_exception'] ?? ($this->privates['kernel.listener.manage_exception'] = new \App\EventListener\AcmeExceptionListener()));
    ...
    protected function getDebug_Security_FirewallService()
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.api' => ($this->privates['.security.request_matcher.t2u6sDf'] ?? ($this->privates['.security.request_matcher.t2u6sDf'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/majpanel/api/')));
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.guard.api_login'] ?? $this->load('getSecurity_Authentication_Provider_Guard_ApiLoginService.php'));
            yield 1 => ($this->privates['security.authentication.provider.dao.api_login'] ?? $this->load('getSecurity_Authentication_Provider_Dao_ApiLoginService.php'));
            yield 2 => ($this->privates['security.authentication.provider.anonymous.api_login'] ?? ($this->privates['security.authentication.provider.anonymous.api_login'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            ...
            yield 4 => ($this->privates['security.authentication.provider.guard.main'] ?? $this->load('getSecurity_Authentication_Provider_Guard_MainService.php'));
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('api_login', 'app_logout', 'logout', '_csrf_token', NULL, NULL);
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'lexik_jwt_authentication.private_key_path': $value = (\dirname(__DIR__, 4).'/'.$this->getEnv('string:JWT_PRIVATE_KEY_PATH')); break;
            case 'lexik_jwt_authentication.public_key_path': $value = (\dirname(__DIR__, 4).'/'.$this->getEnv('string:JWT_PUBLIC_KEY_PATH')); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'env(DATABASE_URL)' => '',
            'locale' => 'en',
            'upload_real_path' => (\dirname(__DIR__, 4).'/public/uploads/'),
            'upload_path' => '/uploads/',
            'rootApp' => \dirname(__DIR__, 4),
