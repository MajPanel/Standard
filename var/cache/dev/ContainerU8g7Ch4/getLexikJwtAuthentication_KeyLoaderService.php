...
return $this->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\RawKeyLoader((\dirname(__DIR__, 4).'/'.$this->getEnv('string:JWT_PRIVATE_KEY_PATH')), (\dirname(__DIR__, 4).'/'.$this->getEnv('string:JWT_PUBLIC_KEY_PATH')), $this->getEnv('JWT_PASSPHRASE'));
